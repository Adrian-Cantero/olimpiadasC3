                    ...
                    <form action="{{ route('cursos.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="curso" id="curso"
                                value="{{ old('curso') }}" class="w-full border-gray-300 rounded-md">
                        </div>
                        <div class="mb-4">
                            <label for="num_olimpiada" class="block text-gray-700">Número de olimpiada</label>
                            <input type="number" name="num_olimpiada" id="num_olimpiada"
                                value="{{ old('num_olimpiada') }}" class="w-full border-gray-300 rounded-md">
                        </div>
                        <div class="mb-4">
